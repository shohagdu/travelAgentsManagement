...
<div class="row margin-top-10px"><br><br><br><br>
    <table class="custom-table  width-100" style="float: right">
        <tr>
            ...
            <td rowspan="3"
                style="text-align: center;border-top: 1px solid #fff;border-right: 1px solid #fff;border-bottom: 1px solid #fff;">
                <h1>Agent Statement</h1></td>
        </tr>
        <tr>
            <td> Address</td>
    ...
    <table class="custom-table  width-100 table" rules="all">
        ...
        @foreach($transaction_info as $item )
            <tr>
                ...
                <td>
                    @if($item->trans_type==1) Sale @elseif($item->trans_type ==2) Credit
                    Bill @elseif($item->trans_type ==3) Debit Bill @endif
