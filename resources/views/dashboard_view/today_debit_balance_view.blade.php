...
@section('title', 'Today Debit Balance')
@section('css')
...
<div class="row">
  <div class="col-12">
    <div class="card">
      <div class="card-body">
        <h5 class="card-title mb-0 lefttButtonText" > Today Debit Balance</h5>
      </div>
      <table class="TodaySaleBalanceTbl" >
        ...
        @foreach ($today_debit_balance as $item )
        ...
        <tr>
          ...
          <td>@php  echo $item->debit_amount; $total_amount += $item->debit_amount;  @endphp</td>
        </tr>
        @endforeach
        <tr>
