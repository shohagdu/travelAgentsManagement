    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="col-sm-2">
          ...
          <div class="col-sm-1">
            <button onclick="search_bank_debit_reports()" id="" class="btn btn-primary">Search</button>
        </div>

        <h5 class="card-title mb-0 lefttButtonText">    <button class="btn btn-success btn-sm text-white rightButton" onclick="AddBankDebit()">
          <i class="mdi mdi-plus-box"></i> Add Bank Debit </button></h5>
      
      </div>
      <table id="BankDebitListTable" class="table table-bordered">
  
      </table>
    </div>
  </div>
  <!-- Bill  modal -->
<div class="modal fade" id="BankDebitModal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
  <form method="post" id="BankDebitForm"  action="javascript:void(0)" >
    @csrf
  <div class="modal-dialog modal-lg ">
    <div class="modal-content ">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">Bank Debit</h4>
