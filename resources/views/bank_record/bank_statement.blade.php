        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0 lefttButtonText">Bank Statement </h5>
                    <a href="{{ route('bank_statement')}}" class="btn btn-danger btn-sm text-white rightButton"> <i class="mdi mdi-refresh"></i>  Refresh  </a>
                    
                </div>
                <div class="card-body">
                    <form method="post" id="bankStatementForm"  action="javascript:void(0)" >
                        <?php echo csrf_field(); ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                                <div style="padding-top: 27px">
                                    <button type="button" onclick="searchBankStatementBtn()"  id="searchBankStatement"
