      ...
      <div class="card-body">
        ...
        <div class="form-group row">
            <div class="col-sm-3"><br>
               <h5> Agent Date Wise Statement</h5>
            </div>
        ...
        <div class="col-sm-1">
          <label> &nbsp;</label>
            <button onclick="search_agent_date_wise_statement_report_reports()" id="" class="btn btn-success text-white">Search</button>
        </div>
      </div>
      <table id="AgentStatementReportListTable" class="table table-bordered">
