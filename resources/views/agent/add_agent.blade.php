        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0 lefttButtonText">Add New Airline Setup</h5>
                    <a href="{{ route('agent-list')}}" class="btn btn-success btn-sm text-white rightButton">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('save-agent')}}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="company_name" class="col-sm-2 text-end control-label col-form-label"> Company
                                Name</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group row">
                            <label for="currency" class="col-sm-2 text-end control-label col-form-label">
                                Country</label>
                            <div class="col-sm-4">
                        ...
                        <div class="form-group row">
                            <label for="zip_code" class="col-sm-2 text-end control-label col-form-label">Zip
                                Code</label>
                            <div class="col-sm-4">
                                <input type="text" name="zip_code" id="zip_code" class="form-control" required
                                       placeholder="Zip Code">
                            </div>
                            <label for="office_phone" class="col-sm-2 text-end control-label col-form-label">Opening
                                Balance</label>
                            <div class="col-sm-4">
