  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="col-sm-1">
            <button onclick="search_iata_debit_reports()" id="" class="btn btn-primary">Search</button>
        </div>
        <h5 class="card-title mb-0 lefttButtonText">    <button class="btn btn-success btn-sm text-white rightButton" onclick="AddIATADebit()">
          <i class="mdi mdi-plus-box"></i> Add IATA Debit </button> 
        </h5>
      </div>
      <table id="IATADebitListTable" class="table table-bordered">
...
<div class="modal fade" id="IATADebitModal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">
  <form method="post" id="IATADebitForm"  action="javascript:void(0)" >
    @csrf
  <div class="modal-dialog modal-lg ">
    <div class="modal-content ">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">IATA Debit</h4>
