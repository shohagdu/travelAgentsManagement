...
class OrganizationSetupController extends Controller
{
    ...
    public function organization_save(Request $request, $id)
    {  
        ...
        if($save){
            return redirect()->route('organization-setup')->with('flash.message', 'Organization Sucessfully Updated!')->with('flash.class', 'success');
        }else{
