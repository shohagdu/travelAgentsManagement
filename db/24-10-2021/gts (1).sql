...
--
-- Host: localhost
-- Generation Time: Oct 24, 2021 at 11:09 AM
...
CREATE TABLE `agent_records` (
  ...
  `office_phone` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `created_ip` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `airline_setups` (
  `id` bigint UNSIGNED NOT NULL,
  `airline_name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `fare` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `country_setups` (
  `id` bigint UNSIGNED NOT NULL,
  `name` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `country_code` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `is_active` tinyint NOT NULL,
  `created_by` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `updated_by` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_ip` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `organization_setups` (
  ...
  `website_address` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `logo` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `templete_logo` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `tradelicense_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vat_no` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `per_invoice_deduction_amount` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tax_amount` decimal(10,2) DEFAULT NULL,
  `ait` decimal(10,2) DEFAULT NULL,
  `is_active` tinyint NOT NULL,
  `created_by` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(3, 'Tripayan Server Ltd', 'dhaka', '01899876723', 'admin@gmail.com', '5345235', 'ewww', 'logo_1634981462.png', 'templete_logo_1634639291.png', 'favicon_1634979459.ico', 'abc', '(GMT-11:00) Midway Island', 'ALL', '234324', '456', '5', '2.00', '4.00', 1, '1', '1', '127.0.0.1', '127.0.0.1', '2021-10-17 03:14:52', '2021-10-23 03:31:02');
...
(2, 1, 1, NULL, NULL, NULL, '32.00', 1, '1', NULL, '127.0.0.1', NULL, '2021-10-19 03:04:00', NULL),
(3, 1, 2, NULL, NULL, NULL, '19.00', 1, '1', NULL, '127.0.0.1', NULL, '2021-10-19 04:08:32', NULL),
(4, 1, 4, '39.00', '4.00', NULL, '35.00', 1, '1', NULL, '127.0.0.1', NULL, '2021-10-23 02:44:29', NULL);
...
CREATE TABLE `sale_categories` (
  ...
  `type` int NOT NULL COMMENT '1=Flights, 2=Hotels, 3=Transfers, 4=Activities, 5=Holidays, 6=Visa, 7=Others',
  `is_active` tinyint NOT NULL,
  `created_by` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `updated_by` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_ip` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `sale_details` (
  ...
  `commission_per` decimal(10,2) NOT NULL,
  `commission_amount` decimal(10,2) NOT NULL,
  `ait_per` decimal(10,2) NOT NULL,
  `ait_amount` decimal(10,2) NOT NULL,
  `add_per` decimal(10,2) NOT NULL,
...
INSERT INTO `sale_details` (`id`, `sale_id`, `airline_id`, `fare`, `tax_per`, `tax_amount`, `total_amount`, `commission_per`, `commission_amount`, `ait_per`, `ait_amount`, `add_per`, `add_amount`, `invoice_amount`, `discount`, `net_amount`, `is_active`, `created_by`, `updated_by`, `created_ip`, `updated_ip`, `created_at`, `updated_at`) VALUES
(1, 2, 1, '12', '2.00', '2.00', '14.00', '10.00', '10.00', '4.00', '4.00', '5.00', '5.00', '13.00', NULL, '13.00', 1, '1', NULL, '127.0.0.1', NULL, '2021-10-19 03:04:00', NULL),
(2, 2, 4, '2', '2.00', '2.00', '4.00', '4.00', '4.00', '4.00', '4.00', '15.00', '15.00', '19.00', NULL, '19.00', 1, '1', NULL, '127.0.0.1', NULL, '2021-10-19 03:04:00', NULL),
(3, 3, 4, '2', '2.00', '2.00', '4.00', '4.00', '4.00', '4.00', '4.00', '15.00', '15.00', '19.00', NULL, '19.00', 1, '1', NULL, '127.0.0.1', NULL, '2021-10-19 04:08:32', NULL),
(4, 4, 4, '2', '2.00', '2.00', '4.00', '4.00', '4.00', '4.00', '4.00', '15.00', '15.00', '19.00', NULL, '19.00', 1, '1', NULL, '127.0.0.1', NULL, '2021-10-23 02:44:29', NULL),
(5, 4, 3, '10', '2.00', '2.00', '12.00', '5.00', '5.00', '4.00', '4.00', '9.00', '9.00', '20.00', NULL, '20.00', 1, '1', NULL, '127.0.0.1', NULL, '2021-10-23 02:44:29', NULL);
