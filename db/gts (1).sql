...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 11, 2021 at 06:13 AM
...
CREATE TABLE `agent_records` (
  ...
  `updated_ip` varchar(15) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `organization_setups` (
  ...
  `website_address` varchar(250) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `tradelicense_no` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `vat_no` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
  `per_invoice_deduction_amount` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'Admin', 'admin@gmail.com', NULL, '$2y$10$FhQmUNBo39dxBq5RO2QJzufyPoB8L.d3w6SdghWYSdmo.kIYpmOUq', NULL, '2021-10-10 22:13:31', '2021-10-10 22:13:31');
